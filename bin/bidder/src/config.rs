...
pub struct Settings {
    ...
    /// Enable additional RPC probes (e.g. bid history lookups) for debugging decisions.
    #[serde(default)]
    pub debug_probe_history: bool,
    /// The maximum number of bid history entries to inspect per request.
    #[serde(default = "default_debug_history_limit")]
    pub debug_history_limit: u32,
}
...
fn default_debug_history_limit() -> u32 {
    5
}
